...
using DocumentFormat.OpenXml.ofapi.Validation;
...
namespace DocumentFormat.OpenXml.Internal.SchemaValidation
{
    ...
    internal class SimpleTypeRestrictions
    {
        ...
        {
            throw new NotImplementedException("binnary formaters problem");
            //todo:binnary formaters problem
            // simpletypes
    ...
    internal class TokenRestriction : StringRestriction
    {
        ...
        public override bool ValidateValueType(OpenXmlSimpleType attributeValue)
        {
            try
            {
                ...
                XmlConvertExtra.VerifyTOKEN(attributeValue.InnerText);
            }
            catch (XmlException)
            {
                return false;
