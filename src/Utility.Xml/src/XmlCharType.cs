...
namespace Utility.Xml
{
    ...
    unsafe public struct XmlCharType {
#else
    public struct XmlCharType
    {
        ...
        public const int fNCStartNameSC = 4;  // SC = Single Char
        public const int fNCNameSC = 8;  // SC = Single Char
        public const int fCharData = 16;
        public const int fNCNameXml4e = 32; // NCName char according to the XML 1.0 4th edition
        ...
        public const string s_Whitespace =
            "\u0009\u000a\u000d\u000d\u0020\u0020";
        ...
        // NOTE: This method will not be inlined (because it uses byte* charProperties)
        public bool IsTextChar(char ch)
        {
        ...
        // NOTE: This method will not be inlined (because it uses byte* charProperties)
        public bool IsAttributeValueChar(char ch)
        {
