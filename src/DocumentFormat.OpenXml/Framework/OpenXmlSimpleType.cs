...
namespace DocumentFormat.OpenXml
{
        ...
        where T : struct
    {
        ...
        internal static string ToString(T enumVal)
        {
            ...
            EnumStringAttribute stringAttr = CustomAttributeExtensions.GetCustomAttribute(fi, typeof(EnumStringAttribute)) as EnumStringAttribute;
            if (stringAttr != null)
            {
        ...
        internal override bool IsInVersion(FileFormatVersions fileFormat)
        {
            ...
            if (!fileFormatInformationLoaded && fileFormatInformations == null)
            {
                ...
                foreach (T enumVal in values)
                {
                    ...
                    OfficeAvailabilityAttribute versionAttr = CustomAttributeExtensions.GetCustomAttribute(fi, typeof(OfficeAvailabilityAttribute)) as OfficeAvailabilityAttribute;
                    if (versionAttr != null)
                    {
                        if (lookupTable == null)
                        {
