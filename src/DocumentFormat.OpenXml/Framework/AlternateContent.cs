...
namespace DocumentFormat.OpenXml
{
   ...
   /// <summary>
    ...
    public sealed class InvalidMCContentException : Exception
    {
        ...
        //private InvalidMCContentException(string info, Exception context) : base(info, context)
        //{
        //}
        ...
        public InvalidMCContentException(string message, Exception innerException) : base(message, innerException)
        {
        }
    }
    ...
    public sealed class  NamespaceNotUnderstandException : Exception
    {
        ...
        /// <param name="info">The SerializationInfo that holds the serialized object data about the exception being thrown.</param>
        /// <param name="context">The StreamingContext that contains contextual information about the source or destination.</param>
        //private NamespaceNotUnderstandException(SerializationInfo info, StreamingContext context): base(info, context)
        //{
        //}
